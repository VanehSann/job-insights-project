...
<details>
  ...
  - Use o comando: `git clone git@github.com:tryber/sd-020-a-project-job-insights.git`.
  - Entre na pasta do repositório que você acabou de clonar:
    - `cd sd-020-a-project-job-insights`
  ...
  - Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-020-a-project-job-insights/pulls)
  ...
  - Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-020-a-project-job-insights/pulls) e confira que o seu _Pull Request_ está criado
